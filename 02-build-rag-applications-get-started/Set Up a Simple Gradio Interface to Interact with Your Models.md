...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/1Nu_NsDz3XJSqVEAPJhAXA/cloud-ide-new-file-revised.png" alt="Alt text" width="50%" height="50%" />

Alternatively, for some browser types, you might need to right-click **PROJECT** and select **New file**.

<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/kmm9uO3_t2mFPGr6JtnJXQ/createfile.png" alt="Alt text" width="50%" height="50%" />

Whichever method you used to create your file, name the file`gradio_demo.py` and select **OK**.

<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/71V6X2-L0NSA4yRt7MFUHA/newfile.png" alt="Alt text" width="50%" height="50%" />
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/c8yfluESyjbIFHM8Q_Lwng/excute.png" alt="Alt text" width="50%" height="50%" />
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/nmKSkEpdjKlU7Sxg4awyog/app.png" alt="Alt text" width="25%" height="50%" />

2.  Next, type your port number in the **Application Port** field and select **Your Application**
    

<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/9AK21jhDZ6iUf59nSEGHcA/app2.png" alt="Alt text" width="50%" height="50%" />
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/PQYvaZM9SEsBX5i9TiywuQ/gradiodemo.png" alt="Alt text" width="50%" height="50%" />
...
<p>	import gradio as gr
	from huggingface_hub import HfFolder
		...
		return a + " " + b</p><p>	demo = gr.Interface(
		fn=combine,
		inputs = [
	...
	demo.launch(server_name="127.0.0.1", server_port= 7860)</p><p></p>
</details>
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/5bjV6F3Dzn5tLzp3UQWn0w/watsonx.png" alt="Alt text" width="55%" height="50%" />
...
This tutorial will walk you through the process of creating a Q&A chatbot using either the Llama or the Mixtral model. You'll also learn how to select the model as you work your way through the tutorial. These powerful foundation models are seamlessly integrated into IBM's watsonx.ai platform, simplifying your development journey. The provided API eliminates the need for generating complex API tokens, streamlining your application creation process. The Llama and Mixtral models both support the following use cases:
...
Since you are creating a Q&A chatbot, the Llama and the Mixtral models align perfectly for this task. For a description of available models on watsonx.ai, please refer [here](https://www.ibm.com/products/watsonx-ai/foundation-models?utm_source=skills_network&utm_content=in_lab_content_link&utm_id=Lab-Gradio+interface+interact+with+LLM-v1_1745852533).

**Note**: The Llama and Mixtral models, like any AI technology, have their limitations, and it is possible to encounter nonsensical responses occasionally. The primary objective of this project is to provide guidence for how to use LLMs with watsonx.ai.
...
model_id = 'meta-llama/llama-4-maverick-17b-128e-instruct-fp8' # Specify llama model
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/a2Tj3VWxnAccg4KqIshiyg/be%20ds.png" alt="Explanation of how to be a good data scientist" width="50%" height="50%" />
...
Moreover, note that, by default, this app uses Llama model. In order to use Mistral AI's Mixtral model instead, all you have to do is change the `model_id` parameter. The necessary instructions for doing so are embedded in the script> Moreover, the code on the following page will provide you with a specific example of building a Q&A bot with Mixtral .
...
2.  Input the code provided above into this new llm\_chat.py file.
...
<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/nbSA43ABX3btuUL9shx4Yw/chatbot-interface-.png" alt="Alt text" width="80%" height="50%" />

Now, you can ask yout chatbot a question.

Here is an example of a question asked of the chatbot and its displayed output.

<img src="https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/l2l5J3OfYqlM_dG1wrOjUA/chatbot-response-.png" alt="Alt text" width="80%" height="50%" />

When you are ready to terminate the script, press `Ctrl+C` in the terminal and close the application window.

Finally, note that this application used the Mixtral model by default. Please compare it to the `simple_llm.py` script that used the Llama model instead. With watsonx.ai all we had to do was change `model_id` to change the model!
...
<p>	GenParams.MAX_NEW_TOKENS: 512,  # Specifying the max tokens you want to generate
	</p>
</details>
...
[Kang Wang](https://author.skills.network/instructors/kang_wang)[Ricky Shi](https://author.skills.network/instructors/ricky_shi)[Wojciech \\\\"Victor\\\\" Fulmyk](https://author.skills.network/instructors/wojciech_fulmyk)
